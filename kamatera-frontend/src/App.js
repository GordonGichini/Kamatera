...
function App() {
  ...
  return (
    <div className="App">
      ...
      <button onClick={() => powerServers('on')}>Start Servers</button>
      <button onClick={() => powerServers('off')}>Stop Servers</button>
      <button onClick={() => powerServers('on')}>Restart Servers</button>
